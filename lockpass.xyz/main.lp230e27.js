    ...
    (this.wordle.bundle = (function (e) {
            ...
            <div class="sections">
              <section>
                <div class="setting">
                  ...
                  <div class="description">Qualquer número revelado terá de ser usado nas tentativas seguintes</div>
                  </div>
                  <div class="control">
        ...
        Ka.innerHTML =
            "\n  <style>\n  .toaster {\n    position: absolute;\n    top: 10%;\n    left: 50%;\n    transform: translate(-50%, 0);\n    pointer-events: none;\n    width: fit-content;\n  }\n  #game-toaster {\n    z-index: "
                ...
                .concat(
                    4e3,
                    ';\n  }\n\n  #game {\n    width: 100%;\n    max-width: var(--game-max-width);\n    margin: 0 auto;\n    height: 100%;\n    display: flex;\n    flex-direction: column;\n  }\n header {\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    height: var(--header-height);\n    color: var(--color-tone-9);\n    border-bottom: 1px solid var(--color-tone-4);\n  }\n\nheader .title {\n    font-weight: 700;\n    font-size: 38px;\n    letter-spacing: 0.05rem;\n    text-transform: uppercase;\n    text-align: center;\n    position: absolute;\n    left: 0;\n    right: 0;\n    pointer-events: none;\n  }\n\n  @media (max-width: 360px) {\n    footer {\n      font-size: 22px;\n      letter-spacing: 0.1rem;\n    }\n  }\n\n  #board-container {\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    flex-grow: 1;\n    overflow: hidden;\n  }\n  #board {\n    display: grid;\n    grid-template-rows: repeat(6, 1fr);\n    grid-gap: 5px;\n    padding:10px;\n    box-sizing: border-box;\n  }\n  button.icon {\n    background: none;\n    border: none;\n    cursor: pointer;\n    padding: 0 4px;\n  }\n\n  footer{color:#f5f2f4; font-size:0.95em; margin-top:3em; text-align:center} #debug-tools {\n    position: absolute;\n    bottom: 0;\n  }\n\n  </style>\n  <game-theme-manager>\n    <div id="game">\n      <header>\n        <div class="menu">\n          <button id="help-button" class="icon" aria-label="help">\n            <game-icon icon="help"></game-icon>\n          </button>\n        </div>\n        <div class="title">\n LOCKPASS\n        </div>\n        <div class="menu">\n          <button id="statistics-button" class="icon" aria-label="statistics">\n            <game-icon icon="statistics"></game-icon>\n          </button>\n          <button id="settings-button" class="icon" aria-label="settings">\n            <game-icon icon="settings"></game-icon>\n          </button>\n        </div>\n      </header>\n        <div id="board-container">\n          <div id="board"></div>\n        </div>\n        <game-keyboard></game-keyboard>\n\n<center><div><strong><a href="https://crisisrelief.un.org/t/ukraine" title="🇺🇦 Doe para Ucrânia">🇺🇦 Doe para Ucrânia</a></div></center> \n        <game-modal></game-modal>\n        <game-page></game-page>\n <div class="text">&nbsp;</div>\n        <div class="toaster" id="game-toaster"></div>\n        <div class="toaster" id="system-toaster"></div>\n    </div>\n  </game-theme-manager>\n  <div id="debug-tools"></div>'
                );
        var Qa = document.createElement("template");
        Qa.innerHTML =
                                    ...
                                    if (this.hardMode) {
                                        ...
                                        if (!o)
                                            return (
                                                ...
                                                void this.addToast(
                                                    n ||
                                                    "Não é permitido no modo difícil"
                                                )
                                            );
                                    }
                                    var r = (function (e, a) {
        ...
        Is.innerHTML = `<div class="countdown">
            ...
            <div class="share">
            <button id="share-button">COMPARTILHE<game-icon icon="share"></game-icon></button>
            </div>`;
        var Ms = {
